(function () {
  TrelloShots.app.factory('boardService', ['$http', '$routeParams', 'api', 'configService', function ($http, $routeParams, api, configService) {
    return {
      all: function () {
      ...
      get: function (boardId) {
        ...
        return $http.get(url).then(function (response) {
          configService.board(response.data.id);
          return response.data;
        });
      },
